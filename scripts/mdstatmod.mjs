...
## Power value per Stat

Stat  			| Weight	| Notes
--------------- | --------- | -----------------------------------------------------------------
Health          | 2/5      	|
Attack			| 5/3		|
Speed			| -			| seems to have no effect on power level?
Defense			| 10/3		|
Tech			| 2/3		|
Crit Damage		| 3/10		| Subtract 100 base crit damage from the characters displayed value
Crit Chance		| 1			| Subtract 5 base crit chance from the characters displayed value
Glancing Damage	| 4/9		|
Glancing Chance | 2/3		|
Resolve			| -			| seems to have no effect on power level?

Notes: For percentages use the whole number ignoring the %. So 10% means: 10 not 0.1.
Example: A 194 Health, 10% Crit Chance particle increases the characters power value by about 88-89 points.
