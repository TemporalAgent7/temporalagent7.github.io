	...
	return (
		<div>
			<Menu fixed='top' inverted>
				<Container>
					<Menu.Item color='red' active={true} onClick={() => router.push('/wiki/retiring')}>
						Retiring
					</Menu.Item>
					...
					<Menu.Item as='a' onClick={() => router.push('/tools')}>
						Player Tools
					</Menu.Item>
					...
					<Menu.Item as='a' onClick={() => router.push('/wiki/about')}>
						About
					</Menu.Item>

					<Dropdown item simple text='Wiki pages'>
						<Dropdown.Menu>
							{allPosts.map((post) => (
								<Dropdown.Item key={post.slug} onClick={() => router.push(`/wiki/${post.slug}`)}>
									{post.title}
								</Dropdown.Item>
							))}
						</Dropdown.Menu>
			...
			<Segment inverted vertical style={{ margin: '2em 0em 0em', padding: '1.5em 0em' }}>
				<Container textAlign='center'>
					<List horizontal inverted divided link size='small'>
						<List.Item as='a' href='https://discord.gg/SzkVaFJCa5'>
							Official Discord
						</List.Item>
						<List.Item as='a' href='https://tpgames.co/g3t'>
							Official Forums
						</List.Item>
						<List.Item as='a' href='https://tpgames.co/4f6fc'>
							Official Game FAQs
						</List.Item>
						<List.Item as='a' href='https://github.com/TemporalAgent7/LegendsDataCore'>
